    ...
    <div class="row g-3 mb-9">
        ...
        <div class="col-md-6">
            ...
            <a href="#" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                <img alt="Logo" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/google-icon.svg' }}" class="h-15px me-3"/>   
                Sign in with Google
            </a>
            <!--end::Google link--->
        </div>
        ...
        <div class="col-md-6">
            <!--begin::Google link--->
            <a href="#" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                <img alt="Logo" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/apple-black.svg' }}" class="theme-light-show h-15px me-3"/>
                <img alt="Logo" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/apple-black-dark.svg' }}" class="theme-dark-show h-15px me-3"/>     
                Sign in with Apple
            </a>
            <!--end::Google link--->
        </div>
...
<!--end::Form--> 
        ...
        <div class="w-lg-500px d-flex flex-stack px-10 mx-auto">
            ...
            <div class="me-10">             
                ...
                <button class="btn btn-flex btn-link btn-color-gray-700 btn-active-color-primary rotate fs-base" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-offset="0px, 0px">
                    <img  data-kt-element="current-lang-flag" class="w-20px h-20px rounded me-3" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/flags/united-states.svg' }}" alt=""/>
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4 fs-7" data-kt-menu="true" id="kt_auth_lang_menu">
                        ...
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link d-flex px-5" data-kt-lang="English">
                                <span class="symbol symbol-20px me-4">
                                    <img data-kt-element="lang-flag" class="rounded-1" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/flags/united-states.svg' }}" alt=""/>
                                </span>
                        ...
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link d-flex px-5" data-kt-lang="Spanish">
                                <span class="symbol symbol-20px me-4">
                                    <img data-kt-element="lang-flag" class="rounded-1" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/flags/spain.svg' }}" alt=""/>
                                </span>
                        ...
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link d-flex px-5" data-kt-lang="German">
                                <span class="symbol symbol-20px me-4">
                                    <img data-kt-element="lang-flag" class="rounded-1" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/flags/germany.svg' }}" alt=""/>
                                </span>
                        ...
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link d-flex px-5" data-kt-lang="Japanese">
                                <span class="symbol symbol-20px me-4">
                                    <img data-kt-element="lang-flag" class="rounded-1" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/flags/japan.svg' }}" alt=""/>
                                </span>
                        ...
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link d-flex px-5" data-kt-lang="French">
                                <span class="symbol symbol-20px me-4">
                                    <img data-kt-element="lang-flag" class="rounded-1" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/flags/france.svg' }}" alt=""/>
                                </span>
    ...
    <!--begin::Aside-->
    <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url({{ env('IMAGE_SHOW_PATH') . 'assets/media/misc/auth-bg.png' }})">
        <!--begin::Content-->
        <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">          
            <!--begin::Logo-->
            <a href="{{ url('/') }}" class="mb-0 mb-lg-12">
                <img alt="Logo" src="{{ env('IMAGE_SHOW_PATH') . $setting->mini_logo }}" onerror="this.src='{{ env('IMAGE_SHOW_PATH') . 'default/mini_logo.png' }}'" class="h-60px h-lg-75px"/>
            </a>    
            <!--end::Logo-->
