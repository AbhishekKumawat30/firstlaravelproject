                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
                            <li class="breadcrumb-item text-muted">{{ isset($data) ? 'Edit FAQ' : 'Add FAQ' }}</li>
                        </ul>
                    </div>
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="card">
                    <div class="card-body py-4">
                        <form id="faqs_add_form" class="form" action="{{ isset($data) ? url('esh2/faqs/edit/'.$data['id']) : url('esh2/faqs/add') }}" enctype="multipart/form-data" method="post">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="question" id="question" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Question" value="{{ $data['question'] ?? '' }}" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="answer" id="answer" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Answer" value="{{ $data['answer'] ?? '' }}" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="fv-row mb-7">
                                            ...
                                            <select id="page_name" class="form-control form-control-solid mb-3 mb-lg-0" name="page_name">
                                                ...
                                                @foreach ($pageNames as $id => $name)
                                                    <option value="{{ $id }}" {{ ($data->page_name ?? '') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="text-center pt-10">
                                ...
                                <button type="button" id="addCustomer" class="btn btn-primary" data-kt-users-modal-action="submit">
                                    <span class="indicator-label">{{ isset($data) ? 'Update' : 'Submit' }}</span>
