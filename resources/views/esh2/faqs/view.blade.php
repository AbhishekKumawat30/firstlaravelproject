            ...
            <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-6 ">
                ...
                <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <a href="{{ url('esh2/faqs/add') }}" class="d-flex btn btn-sm fw-bold btn-primary">
                                            ...
                                            @foreach ($data as $enq)
                                                <tr data-id="{{ $enq->id ?? '' }}" class="enquiryTr">
                                                    <td class="pt-0 d-flex">
                                                        ...
                                                        <!-- Edit Button -->
                                                        <a target="_blank"
                                                            href="{{ url('esh2/faqs/edit') }}/{{ $enq->id }}"
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form action="{{ url('esh2/faqs/delete/' . $enq->id) }}"
                                                            method="POST"
                                                    ...
                                                    <td class="pt-0">{{ $i++ }}</td>
                                                    <td class="pt-0"><small>{{ $enq->question ?? '' }}</small></td>
                                                    <td class="pt-0"><small>{{ $enq->answer ?? '' }}</small></td>
                                                    <td class="pt-0">
                                                        <small>{{ $pageNames[$enq->page_name] ?? '' }}</small>
                                                    </td>
                                                    <td>
                                                        @if ($enq->status == 1)
