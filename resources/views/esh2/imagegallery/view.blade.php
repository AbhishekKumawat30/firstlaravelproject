...
@section('content')
    ...
    @endif-->
                        ...
                        <a href="{{ url('esh2/imagegallery/add') }}" class="d-flex btn btn-sm fw-bold btn-primary">
                                            ...
                                            @foreach ($data as $enq)
                                                <tr data-id="{{ $enq->id ?? '' }}" class="enquiryTr">
                                                    ...
                                                    <td class="pt-0 d-flex">
                                                        ...
                                                        <!-- Edit Button -->
                                                        <a target="_blank"
                                                            href="{{ url('esh2/imagegallery/edit') }}/{{ $enq->id }}"
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form action="{{ url('esh2/imagegallery/delete/' . $enq->id) }}"
                                                            method="POST"
                                                    ...
                                                    <td class="pt-0 align-items-center">
                                                        {{ $enq->eventname ?? '' }} <br> <small>
                                                    </td>
                                                    <td>
                                                        <img src="{{ env('IMAGE_SHOW_PATH') . 'esh2/imagegallery/' . $enq->image }}"
                                                            alt="Enquiry image"
