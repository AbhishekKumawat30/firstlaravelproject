...
@section('content')
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <div class="m-0">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-md-1000px" data-kt-menu="true"
                                ...
                                <!--begin::Form-->
                                <div class="px-7 py-5">
                                    <form action="{{ url('esh2/inventery/list') }}" method="post" class="row">
                                        @csrf
    ...
    @endif-->
                        ...
                        <a href="{{ url('esh2/inventery/add') }}" class="d-flex btn btn-sm fw-bold btn-primary">
            ...
            <div class="align-items-center gap-2 gap-lg-3 p-3"
                ...
                <form action="{{ url('esh2/inventery/list') }}" method="post" class="align-content-center">
                    @csrf
                                            ...
                                            @foreach ($data as $enq)
                                                <tr data-id="{{ $enq->id ?? '' }}" class="enquiryTr">
                                                    ...
                                                    <td class="pt-0 d-flex">
                                                        ...
                                                        <!-- Edit Button -->
                                                        <a target="_blank" href="{{ url('esh2/inventery/edit') }}/{{ $enq->id }}" 
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form action="{{ url('esh2/inventery/delete/'.$enq->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Offer?');">
                                                            @csrf
                                                            @method('DELETE')
                                                    ...
                                                    <td class="pt-0">{{ $i++ }}</td>
                                                    <td class="pt-0"><small>{{ $enq->company ?? '' }}</small></td>
                                                    <td class="pt-0"><small>{{ $enq->item_name ?? '' }}</small></td>
                                                    <td class="pt-0"><small>{{ $enq->quantity_stock ?? '' }}</small></td>
                                                    <td class="pt-0"><small>{{ $enq->amount ?? '' }}</small></td>
                                                    <td class="pt-0"><small>{{ $enq->total_amount ?? '' }}</small></td>
                                                    <td class="pt-0"><small>{{ $enq->available_stock ?? '' }}</small></td>
