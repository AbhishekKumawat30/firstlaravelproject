...
@section('content')
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <div class="m-0">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-md-1000px" data-kt-menu="true"
                                ...
                                <!--begin::Form-->
                                <div class="px-7 py-5">
                                    <form action="{{ url('esh2/homeslider/list') }}" method="post" class="row">
                                        @csrf
    ...
    @endif-->
                        ...
                        <a href="{{ url('esh2/homeslider/add') }}" class="d-flex btn btn-sm fw-bold btn-primary">
            ...
            <div class="align-items-center gap-2 gap-lg-3 p-3"
                ...
                <form action="{{ url('esh2/homeslider/list') }}" method="post" class="align-content-center">
                    @csrf
                                            ...
                                            @foreach ($data as $enq)
                                                <tr data-id="{{ $enq->id ?? '' }}" class="enquiryTr">
                                                    ...
                                                    <td class="pt-0 d-flex">
                                                        ...
                                                        <!-- Edit Button -->
                                                        <a target="_blank"
                                                            href="{{ url('esh2/homeslider/edit') }}/{{ $enq->id }}"
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form action="{{ url('esh2/homeslider/delete/' . $enq->id) }}"
                                                            method="POST"
                                                    ...
                                                    <td>
                                                        <img src="{{ env('IMAGE_SHOW_PATH') . 'esh2/homeslider/' . $enq->photo }}"
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            url: "{{ url('esh2/homeslider/statusChange') }}",
                            type: "POST",
                            data: formData,
                            success: function(response) {
                                if (response.success) {
