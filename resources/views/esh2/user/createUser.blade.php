...
<form id="kt_modal_add_user_form" class="form" action="{{ url('esh2/user/create') }}" enctype="multipart/form-data"  method="post" >
       @csrf
                    <!--begin::Scroll-->
                    <div 
...
$(document).ready(function(){
    ...
    <!--begin::Custom Javascript(used for this page only)-->
            <script src="{{ URL::asset('public/assets/js/custom/apps/user-management/users/list/table.js') }}"></script>
            <script src="{{ URL::asset('public/assets/js/custom/apps/user-management/users/list/export-users.js') }}"></script>
            <script src="{{ URL::asset('public/assets/js/custom/apps/user-management/users/list/add.js') }}"></script>
