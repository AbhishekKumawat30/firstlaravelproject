...
>
	...
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo1.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="/{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo2.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo39.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo31.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo9.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo38.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo30.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo6.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo60.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo8.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo62.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo58.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo56.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo34.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo27.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo29.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo57.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo3.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo36.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo20.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo59.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo55.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo51.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo10.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo61.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo52.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo63.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo40.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo23.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo64.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo35.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo33.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo19.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo25.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo50.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo32.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo37.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo42.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo5.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo16.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo4.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo53.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo7.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo21.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo24.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo28.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo44.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo11.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo26.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo22.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo41.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo18.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo54.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo15.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo14.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo13.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo12.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo48.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo17.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo49.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo43.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo45.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo47.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/demos/demo46.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/multipurpose-demo1.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/marketing.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/social.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/ecommerce.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/store-analytics.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/logistics.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/delivery.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/online-courses.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/school.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/crypto.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/finance-performance.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/website-analytics.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/bidding.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/podcast.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/projects.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/call-center.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/dashboards/pos.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/apps/projects.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/apps/ecommerce.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/apps/customers.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/apps/subscriptions.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/apps/user-management.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/apps/invoices.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/apps/support-center.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/apps/chat.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/apps/calendar.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/apps/file-manager.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/apps/inbox.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/apps/contacts.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->	</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/auth-corporate.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/auth-creative.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/auth-fancy.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/auth-overlay.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/auth-multistep.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/auth-2factor.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/auth-passwordchanged.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/auth-verifyemail.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/auth-welcome.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/auth-comingsoon.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/auth-accountdeactivated.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/auth-404.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/auth-500.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/profile-overview.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/profile-campaigns.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/profile-documents.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/profile-followers.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/profile-activity.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/corporate-aboutus.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/corporate-contactus.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/corporate-license.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/corporate-ourteam.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/corporate-sitemap.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/social-activity.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/social-feeds.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/social-followers.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/social-settings.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/faq-classic.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/faq-extended.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/blog-home.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/blog-post.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->			</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/account-overview.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/account-settings.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/account-billing.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/account-security.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/account-referrals.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/account-logs.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/account-apikeys.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/account-statements.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-viewfriends.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-upgradeplan.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-topupwallet.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-shareandearn.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-selectuser.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-placeyourbid.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-offeradeal.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-newtarget.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-newcard.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-newaddress.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-invitefriend.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-createproject.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-createcampaign.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-createbusinessacc.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-createapp.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-createapikey.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/modal-2factorauth.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/wizard-2factorauth.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/wizard-horizontal.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/wizard-vertical.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/search-users.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/search-horizontal.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/search-vertical.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/search-location.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/widgets-charts.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/widgets-feeds.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/widgets-lists.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/widgets-mixed.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/widgets-stats.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/widgets-tables.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/email-welcome.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/email-subscriptionconfirmed.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/email-resetpassword.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/email-creditcarddeclined.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/email-promo1.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/email-promo2.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
>
	...
	<!--begin::Thumbnail-->
	<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
		<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/placeholder.jpg' }}" data-src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/prebuilts/pages/email-promo3.png' }}" class="lozad w-100 rounded" alt=""/>
	</span>
	<!--end::Thumbnail-->
</a>
<!--end::Preview-->		</div>
...
<div 
    ...
    style="background-image:url('{{ env('IMAGE_SHOW_PATH') . 'assets/media/misc/layout/customizer-header-bg.jpg' }}')">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success">
					...
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/preview/demos/demo1/light-ltr.png' }}" class="form-check-rounded mw-100" alt=""/>                      
					</div>
					<!--end::Image--> 
	...
	<div class="row gy-3" data-kt-buttons="true" data-kt-buttons-target=".form-check-image:not(.disabled),.form-check-input:not([disabled])">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success active  active"  >
					<!--begin::Image-->
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/misc/layout/dark-sidebar.png' }}" class="form-check-rounded mw-100" alt=""/>                            
					</div>
					<!--end::Image-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success   "  >
					<!--begin::Image-->
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/misc/layout/light-sidebar.png' }}" class="form-check-rounded mw-100" alt=""/>                            
					</div>
					<!--end::Image-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success   "  >
					<!--begin::Image-->
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/misc/layout/dark-header.png' }}" class="form-check-rounded mw-100" alt=""/>                            
					</div>
					<!--end::Image-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success   "  >
					<!--begin::Image-->
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/misc/layout/light-header.png' }}" class="form-check-rounded mw-100" alt=""/>                            
					</div>
					<!--end::Image-->
