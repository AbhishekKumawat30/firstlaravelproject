...
<div id="kt_app_header" class="app-header " 
	...
	<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
		<a href="{{ url('/') }}" class="d-lg-none">
			<img alt="Logo" src="{{ env('IMAGE_SHOW_PATH') . $setting->mini_logo }}" onerror="this.src='{{ env('IMAGE_SHOW_PATH') . 'default/mini_logo.png' }}'" class="h-30px"/>
		</a>
	</div>
	<!--end::Mobile logo-->
...
<div class="row">
    ...
    <!--begin:Col-->
    <div class="col-lg-4">
        <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-82.jpg' }}" class="rounded mw-100" alt=""/>
    </div>
    <!--end:Col-->
</div>
<!--end:Row-->            
...
<div class="row">
    ...
    <!--begin:Col-->
    <div class="col-lg-7">
        <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/900x600/46.jpg' }}" class="rounded mw-100" alt=""/>
    </div>
    <!--end:Col-->
</div>
<!--end:Row-->        </div>
...
<div class="row">
    ...
    <div class="col-lg-5 pe-lg-5">
        <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-84.jpg' }}" class="rounded mw-100" alt=""/>
    </div>
    <!--end:Col-->
</div>
<!--end:Row-->        </div>
...
<div class="row">
    ...
    <!--begin:Col-->
    <div class="col-lg-8">
        <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/900x600/44.jpg' }}" class="rounded mw-100" alt=""/>
    </div>
    <!--end:Col-->
</div>
<!--end:Row-->        </div>
...
<div class="menu-active-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6" data-kt-menu-dismiss="true">
    ...
    <div class="row">
        ...
        <div class="col-lg-5 mb-3 py-lg-3 pe-lg-8 d-flex align-items-center">
            <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/900x600/45.jpg' }}" class="rounded mw-100" alt=""/>
        </div>
        <!--end:Col-->
    </div>
    <!--end:Row-->
    ...
    <div class="scroll-y mh-200px mh-lg-350px">
            ...
            <!--end::Category title-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-6.jpg' }}" alt=""/>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-2.jpg' }}" alt=""/>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-9.jpg' }}" alt=""/>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-14.jpg' }}" alt=""/>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-11.jpg' }}" alt=""/>
                        </div>
                        <!--end::Symbol-->
            ...
            <!--end::Category title-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">                             
                                <img class="w-20px h-20px" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/volicity-9.svg' }}" alt=""/>                          
                            </span>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">                             
                                <img class="w-20px h-20px" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/tvit.svg' }}" alt=""/>                          
                            </span>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">                             
                                <img class="w-20px h-20px" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/misc/infography.svg' }}" alt=""/>                          
                            </span>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">                             
                                <img class="w-20px h-20px" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/leaf.svg' }}" alt=""/>                          
                            </span>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">                             
                                <img class="w-20px h-20px" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/tower.svg' }}" alt=""/>                          
                            </span>
                        </div>
                        <!--end::Symbol-->
...
<!--<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">-->
	<!--begin::Heading-->
<!--    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{ env('IMAGE_SHOW_PATH') . 'assets/media/misc/menu-header-bg.jpg' }}')">-->
        <!--begin::Title-->                                   
...
<!--                    <img class="mw-100 mh-200px" alt="image" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/illustrations/sketchy-1/1.png' }}"/>-->
<!--                </div>-->
                <!--end::Illustration-->
<!--            </div>-->
            <!--end::Wrapper-->
                ...
                <div class="row g-2">
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/amazon.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/angular-icon-1.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/atica.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/beats-electronics.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/codeigniter.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/bootstrap-4.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/google-tag-manager.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/disqus.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/dribbble-icon-1.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/google-play-store.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/google-podcasts.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/figma-1.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/github.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/gitlab.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/instagram-2-1.svg' }}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/brand-logos/pinterest-p.svg' }}" class="w-25px h-25px mb-2" alt=""/>
...
<!--end::Menu-->
    ...
    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-35px" 
            ...
            data-kt-menu-placement="bottom-end">
            <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-3.jpg' }}" class="rounded-3" alt="user"/>
        </div>
    ...
    <div class="menu-item px-3">
        <div class="menu-content d-flex align-items-center px-3">
            ...
            <div class="symbol symbol-50px me-5">
                <img alt="Logo" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-3.jpg' }}"/>
            </div>
            <!--end::Avatar-->
            ...
            <div class="d-flex flex-column">
                <div class="fw-bold d-flex align-items-center fs-5">
                    {{ Session::get('name') ?? '' }}                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span>
                </div>
        ...
        <a href="#" class="menu-link px-5">
            <span class="menu-title position-relative">
                ...
                <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                    English <img class="w-15px h-15px rounded-1 ms-2" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/flags/united-states.svg' }}" alt=""/>
                </span>
            </span>
        </a>
        ...
        <div class="menu-sub menu-sub-dropdown w-175px py-4">
            ...
            <div class="menu-item px-3">
                <a href="account/settings.html" class="menu-link d-flex px-5 active">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/flags/united-states.svg' }}" alt=""/>
                    </span>
                    English
                </a>
            </div>
            ...
            <div class="menu-item px-3">
                <a href="account/settings.html" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/flags/spain.svg' }}" alt=""/>
                    </span>
                    Spanish
                </a>
            </div>
            ...
            <div class="menu-item px-3">
                <a href="account/settings.html" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/flags/germany.svg' }}" alt=""/>
                    </span>
                    German
                </a>
            </div>
            ...
            <div class="menu-item px-3">
                <a href="account/settings.html" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/flags/japan.svg' }}" alt=""/>
                    </span>
                    Japanese
                </a>
            </div>
            ...
            <div class="menu-item px-3">
                <a href="account/settings.html" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/flags/france.svg' }}" alt=""/>
                    </span>
                    French
                </a>
            </div>
        ...
        <div class="pe-3 mb-5">
            ...
            <div class="d-flex align-items-center mt-1 fs-6">
                ...
                <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-14.jpg' }}" alt="img"/>
                </div>  
                <!--end::User--> 
            </div>
            <!--end::Description-->
        ...
        <div class="overflow-auto pb-5">
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">  
                ...
                <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                    ...
                    <div class="symbol symbol-circle symbol-25px">
                        <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-2.jpg' }}" alt="img"/>
                    </div>
                    <!--end::User-->
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">  
                ...
                <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                    <!--begin::User-->
                    <div class="symbol symbol-circle symbol-25px">
                        <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-20.jpg' }}" alt="img"/>
                    </div>
                    <!--end::User-->                               
        ...
        <div class="overflow-auto pe-3">
            ...
            <div class="d-flex align-items-center mt-1 fs-6">
                ...
                <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-1.jpg' }}" alt="img"/>
                </div>  
                <!--end::User--> 
            </div>
            <!--end::Description-->
        ...
        <div class="mb-5 pe-3">
            ...
            <div class="d-flex align-items-center mt-1 fs-6">
                ...
                <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-23.jpg' }}" alt="img"/>
                </div>  
                <!--end::User--> 
            </div>
            <!--end::Description-->
        ...
        <div class="overflow-auto pb-5">
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                ...
                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">  
                    <!--begin::Icon-->                                  
                    <img alt="" class="w-30px me-3" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/files/pdf.svg' }}"/>
                    <!--end::Icon--> 
                ...
                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">   
                    <!--begin::Icon-->                                  
                    <img alt="/metronic8/demo1/../demo1/apps/projects/project.html" class="w-30px me-3" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/files/doc.svg' }}"/>
                    <!--end::Icon--> 
                ...
                <div class="d-flex flex-aligns-center">   
                    <!--begin::Icon-->                                  
                    <img alt="/metronic8/demo1/../demo1/apps/projects/project.html" class="w-30px me-3" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/svg/files/css.svg' }}"/>
                    <!--end::Icon--> 
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                ...
                <div class="overlay me-10">  
                    ...
                    <div class="overlay-wrapper">
                        <img alt="img" class="rounded w-150px" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x400/img-29.jpg' }}"/>  
                    </div>
                    <!--end::Image-->
                ...
                <div class="overlay me-10">   
                    <!--begin::Image-->                                     
                    <div class="overlay-wrapper">
                        <img alt="img" class="rounded w-150px" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x400/img-31.jpg' }}"/> 
                    </div>
                    <!--end::Image-->
                ...
                <div class="overlay">   
                    <!--begin::Image-->                                     
                    <div class="overlay-wrapper">
                        <img alt="img" class="rounded w-150px" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x400/img-40.jpg' }}"/>
                    </div>
                    <!--end::Image-->
        ...
        <div class="pe-3 mb-5">
            ...
            <div class="d-flex align-items-center mt-1 fs-6">
                ...
                <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
                    <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-4.jpg' }}" alt="img"/>
                </div>  
                <!--end::User--> 
            </div>
            <!--end::Description-->
    ...
    <div class="d-flex justify-content-start mb-10 " >
        ...
        <div class="d-flex flex-column align-items-start">
            ...
            <div class="d-flex align-items-center mb-2">
                                    <!--begin::Avatar--><div class="symbol  symbol-35px symbol-circle "><img alt="Pic" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-25.jpg' }}"/></div><!--end::Avatar-->
                    <!--begin::Details-->
                    <div class="ms-3">
    ...
    <div class="d-flex justify-content-end mb-10 " >
        ...
        <div class="d-flex flex-column align-items-end">
            ...
            <div class="d-flex align-items-center mb-2">
                    ...
                    <!--begin::Avatar--><div class="symbol  symbol-35px symbol-circle "><img alt="Pic" src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-1.jpg' }}"/></div><!--end::Avatar-->                 
            </div>
            <!--end::User-->
        ...
        <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x400/img-1.jpg' }}" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <!--begin::Pic--> 
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x400/img-3.jpg' }}" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <!--begin::Pic--> 
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x400/img-8.jpg' }}" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <!--begin::Pic--> 
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x400/img-26.jpg' }}" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <!--begin::Pic--> 
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x400/img-21.jpg' }}" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <!--begin::Pic--> 
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x400/img-34.jpg' }}" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <!--begin::Pic--> 
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x400/img-27.jpg' }}" alt=""/>   
                    </div>                                       
                    <!--end::Pic-->            
                </div>
                <!--end::Item-->
