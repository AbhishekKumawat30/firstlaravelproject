    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            ...
            <!--        </div>-->
                ...
                @else
                    <a class="menu-link" href="{{ url('/') }}/{{ $side2->url ?? '' }}"><span class="menu-icon"><i class="ki-duotone {{ $side2->icon ?? '' }} fs-1"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i></span><span class="menu-title">{{ $side2->sidebar2 ?? '' }}</span></a>
                @endif
