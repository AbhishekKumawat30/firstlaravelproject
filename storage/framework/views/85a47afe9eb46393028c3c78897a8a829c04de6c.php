...
<form id="expenses_add_form" class="form" action="<?php echo e(url('esh2/expense/add')); ?>" enctype="multipart/form-data" method="post" >
    <?php echo csrf_field(); ?>
                    <!--begin::Scroll-->
                    <div 
                    ...
                    <div class="row">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <input type="date" name="form_date" id="form_date" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="form_date" value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <input type="date" name="to_date" id="to_date" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Expense to_date" value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <input type="text" name="user_name" id="user_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="user_name" value="" />
                            <!--end::Input-->
                        </div>
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <input type="date" name="Expense Date" id="Expense Date" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Mobile 2" value="" />
                            <!--end::Input-->
                        </div>
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <input type="email" name="pay_status" id="pay_status" class="form-control  mb-3 mb-lg-0" placeholder="Pay Status" value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        </div>
                    ...
                    <div class="text-center pt-10">
                        ...
                        <button type="button" id="addExpense" class="btn btn-primary" data-kt-users-modal-action="submit">
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/expense/gettingStarted.blade.php ENDPATH**/ ?>