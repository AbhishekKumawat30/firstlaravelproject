                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="number" id="promo_code" name="promo_code" class="form-control"
                                                value="<?php echo e($data['promo_code'] ?? ''); ?>">
                                        </div>
                                        <!--end::Input group-->
                                    </div>
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/offers/edit.blade.php ENDPATH**/ ?>