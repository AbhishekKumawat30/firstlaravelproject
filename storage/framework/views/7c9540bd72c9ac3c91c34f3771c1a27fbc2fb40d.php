...
.quick-menu[x-placement^="bottom"], .quick-menu[x-placement^="left"], .quick-menu[x-placement^="right"], .quick-menu[x-placement^="top"] {
  right: auto;
  bottom: auto;
}
.quick-menu {
...
@media  only screen and (max-width: 990px) {
  .quick-menu {
    ...
    <aside class="main-sidebar bg-light  elevation-4">
      ...
      <img src="<?php echo e(env('IMAGE_SHOW_PATH').'/setting/left_logo/'.$getSetting['left_logo'] ?? ''); ?>" alt="" class="brand-image img-circle elevation-3" onerror="this.src='<?php echo e(env('IMAGE_SHOW_PATH').'/default/rukmani_logo.png'); ?>'">
      <span class="brand-text font-weight-light text-white"><?php echo e($getSetting->name); ?></span>
    </a>
...
<!--        <a href="<?php echo e(url('#')); ?>" class="dropdown-item dropdown-footer"><i class="fa fa-calendar-check-o"></i> <?php echo e(__('staff.Staff Panel')); ?> </a>
       ...
       <a href="<?php echo e(url('notice_board/view')); ?>" class="dropdown-item dropdown-footer"><i class="fa fa-bullhorn"></i> <?php echo e(__('messages.Notice Board')); ?></a>--> 
        ...
        <!-- /.sidebar -->
    </aside><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/layout/sidebar.blade.php ENDPATH**/ ?>