<?php $__env->startSection('content'); ?>
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <div class="m-0">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-md-1000px" data-kt-menu="true"
                                ...
                                <!--begin::Form-->
                                <div class="px-7 py-5">
                                    <form action="<?php echo e(url('esh2/expense/list')); ?>" method="post" class="row">
                                        <?php echo csrf_field(); ?>
    ...
    <?php endif; ?>-->
                        ...
                        <a href="<?php echo e(url('esh2/expense/gettingStarted')); ?>"
                            class="d-flex btn btn-sm fw-bold btn-primary">
            ...
            <div class="align-items-center gap-2 gap-lg-3 p-3"
                ...
                <form action="<?php echo e(url('esh2/expense/list')); ?>" method="post" class="align-content-center">
                    <?php echo csrf_field(); ?>
                                            ...
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr data-id="<?php echo e($enq->id ?? ''); ?>" class="enquiryTr">
                                                    ...
                                                    <td class="pt-0 d-flex">
                                                        ...
                                                        <a target="_blank"
                                                            href="<?php echo e(url('esh2/expense/edit')); ?>/<?php echo e($enq->id); ?>"
                                                            class="btn btn btn-icon btn-info me-2 mb-2 btn-outline btn-outline-dashed btn-outline-info pulse pulse-info "><i
                                                                class="ki-duotone ki-pencil fs-7"><span
                                                                    class="path1"></span><span
                                                                    class="path2"></span></i><span
                                                                class="pulse-ring"></span></a>
                                                    </td>
                                                    <td class="pt-0"><?php echo e($i++); ?></td>
                                                    <td>
                                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                            <a class="text-dark" target="blank"
                                                                href="https://web.rusoft.in/esh2/enquiry/view/<?php echo e($enq->id ?? ''); ?>">
                                                                <?php if(!empty($enq->image)): ?>
                                                                    <div class="symbol-label"><img
                                                                            src="<?php echo e(env('IMAGE_SHOW_PATH') . 'esh2/expense/' . $enq->image); ?>"
                                                                            alt="Enquiry Image" class="w-100" /></div>
                                                                <?php else: ?>
                                                                    <div
                                                                        class="symbol-label fs-3 bg-light-danger text-danger">
                                                                        <?php echo e($enq->name[0] ?? ''); ?></div>
                                                                <?php endif; ?>
                                                            </a></div>
                                                    ...
                                                    <td class="pt-0 align-items-center">
                                                        ...
                                                        <?php echo e($enq->name ?? ''); ?> <br> <small> <span class="text-primary">
                                                                Reg. Date: <?php echo e(date('d-M-Y', strtotime($enq->created_at))); ?>

                                                            </span> <span class="text-success">Email:
                                                                <?php echo e($enq->email ?? ''); ?></span> <br>
                                                            <?php echo e($enq->address ?? ''); ?> </small>

                                                    </td>
                                                    <td class="pt-0"><small><a
                                                                href="tel://<?php echo e($enq->mobile ?? ''); ?>"><?php echo e($enq->mobile ?? ''); ?></a>
                                                            <br> </small>
                                                        <small><a
                                                                href="tel://<?php echo e($enq->mobile2 ?? ''); ?>"><?php echo e($enq->mobile2 ?? ''); ?></a>
                                                    </td>
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/expense/list.blade.php ENDPATH**/ ?>