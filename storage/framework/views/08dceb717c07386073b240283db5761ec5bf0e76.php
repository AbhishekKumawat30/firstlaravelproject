<?php $__env->startSection('content'); ?>
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <div class="m-0">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-md-1000px" data-kt-menu="true"
                                ...
                                <!--begin::Form-->
                                <div class="px-7 py-5">
                                    <form action="<?php echo e(url('esh2/branchs/list')); ?>" method="post" class="row">
                                        <?php echo csrf_field(); ?>
    ...
    <?php endif; ?>-->
                        ...
                        <a href="<?php echo e(url('esh2/branchs/add')); ?>"
            ...
            <div class="align-items-center gap-2 gap-lg-3 p-3"
                ...
                <form action="<?php echo e(url('esh2/branchs/list')); ?>" method="post" class="align-content-center">
                    <?php echo csrf_field(); ?>
                                            ...
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr data-id="<?php echo e($enq->id ?? ''); ?>" class="enquiryTr">
                                                    ...
                                                    <td class="pt-0 d-flex">
                                                        ...
                                                        <!-- Edit Button -->
                                                        <a target="_blank" href="<?php echo e(url('esh2/branchs/edit')); ?>/<?php echo e($enq->id); ?>" 
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form action="<?php echo e(url('esh2/branchs/delete/'.$enq->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this expenses?');">
                                                            <?php echo csrf_field(); ?>
                                                    ...
                                                    <td class="pt-0"><small><?php echo e($enq->branch_name ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->owner_name ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->branch_code ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->gst_no ?? ''); ?></small></td>
                                                    <td>
                                                        <?php if($enq->status == 1): ?>
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            url: "<?php echo e(url('esh2/branchs/statusChange')); ?>",
                            type: "POST",
                            data: formData,
                            success: function(response) {
                                if (response.success) {
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/branchs/list.blade.php ENDPATH**/ ?>