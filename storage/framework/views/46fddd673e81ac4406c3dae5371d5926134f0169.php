...
<?php $__env->startSection('content'); ?>
        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-6 ">
                ...
                <div class="text-end mt-1">
                    <a href="<?php echo e(url('esh2/imagegallery/view')); ?>" class="btn btn-primary d-flex align-items-center"
            ...
            <div id="kt_app_content_container" class="app-container  container-xxl ">
                ...
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        ...
                        <form id="imagegallery_add_form" class="form" action="<?php echo e(url('esh2/imagegallery/add')); ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Input-->
                                            <!--begin::Error Message-->
                                            <span id="image_error" class="text-danger" style="display: none;">The image
                            ...
                            <div class="text-center pt-10">
                                ...
                                <button type="button" id="addImagegallery" class="btn btn-primary"
    ...
    <script>
        $(document).ready(function() {
            $('#addImagegallery').click(function() {
                ...
                // Check if event name is "Select" or empty
                if (eventName == "select") {
                ...
                if (isValid) {
                    var formData = new FormData($("#imagegallery_add_form")[0]);
                    $.ajax({
                        headers: {
                            'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
                        },
                        url: baseurl + '/esh2/imagegallery/add',
                        method: 'post',
                        data: formData,
                        processData: false,
                        contentType: false,
                            ...
                            if (response.status == 1) {
                                Swal.fire({
                                    ...
                                    window.location.href =
                                        "<?php echo e(url('esh2/imagegallery/view')); ?>"; // Update this path
                                });
                            } else {
                                Swal.fire({
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/imagegallery/add.blade.php ENDPATH**/ ?>