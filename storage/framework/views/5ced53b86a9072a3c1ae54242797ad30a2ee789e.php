    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div class="text-end mt-1">
                <a href="<?php echo e(url('esh2/homeslider/list')); ?>" class="btn btn-primary d-flex align-items-center" style="font-size: 0.99rem; padding: 5px 10px;">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card">
                <div class="card-body py-4">
                    <form id="homeslider_edit_form" class="form" action="<?php echo e(url('esh2/homeslider/edit')); ?>" enctype="multipart/form-data" method="post">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control form-control-solid" placeholder="Name" value="<?php echo e($homeslider->name); ?>" />
                                ...
                                <div class="col-md-6">
                                    <div class="fv-row mb-7">
                                        ...
                                        <?php if($homeslider->photo): ?>
                                            <img src="<?php echo e(asset('path/to/photos/' . $homeslider->photo)); ?>" alt="Current Photo" class="img-thumbnail mt-2" style="width: 100px;">
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div> 
...
<script>
    $(document).ready(function () {
        $('#editHomeslider').click(function () {
            ...
            if (name === "" && $('#name').val() !== "<?php echo e($homeslider->name); ?>") {
                $('#name_error').show();
                valid = false;
            }
            ...
            if (valid) {
                ...
                var homesliderId = '<?php echo e($homesliderId); ?>';

                $.ajax({
                    headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                    url: '<?php echo e(url("esh2/homeslider/edit")); ?>/' + homesliderId,
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function (response) {
                        if (response.status === 1) {
                            Swal.fire({
                                ...
                                window.location.href = '<?php echo e(url("esh2/homeslider/list")); ?>';
                            });
                        } else {
                            Swal.fire({
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/homeslider/edit.blade.php ENDPATH**/ ?>