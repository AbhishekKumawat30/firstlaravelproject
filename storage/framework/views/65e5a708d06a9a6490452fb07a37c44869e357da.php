                  ...
                  <table class="_table" id="tableId">
                    ...
                    <tbody id="table_body">
                      ...
                      <?php
                        ...
                        $isDeleteAllowed2 = DB::table('fees_assign_details')->where('fees_group_id',$item->fees_group_id)->where('session_id',Session::get('session_id'))->where('branch_id',Session::get('branch_id'))->whereNull('deleted_at')->count();
                     ?>
                      <tr id="appendRow_0">
...
unset($__errorArgs, $__bag); ?>" id="fees_group_id" name="fees_group_id[]">
                            <option value=""><?php echo e(__('messages.Select')); ?></option>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/fees/fees_master/feesMasterEdit.blade.php ENDPATH**/ ?>