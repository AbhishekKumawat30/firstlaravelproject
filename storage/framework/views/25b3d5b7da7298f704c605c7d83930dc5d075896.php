...
unset($__errorArgs, $__bag); ?>" id="select-time"  name="time" required>  
                    ...
                    <tbody class="student_list_show">
                        <?php if(!empty($data)): ?>
                                ...
                                <?php if(Session::get('role_id') != 1): ?>
                                    <?php if($item->id == Session::get('teacher_id')): ?>    
                                    <tr>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/staff/staff_attendance/add.blade.php ENDPATH**/ ?>