<?php $__env->startSection('content'); ?>
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <div class="m-0">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-md-1000px" data-kt-menu="true"
                                ...
                                <!--begin::Form-->
                                <div class="px-7 py-5">
                                    <form action="<?php echo e(url('esh2/expenses/list')); ?>" method="post" class="row">
                                        <?php echo csrf_field(); ?>
    ...
    <?php endif; ?>-->
                        ...
                        <a href="<?php echo e(url('esh2/expenses/add')); ?>"
            ...
            <div class="align-items-center gap-2 gap-lg-3 p-3"
                ...
                <form action="<?php echo e(url('esh2/expenses/list')); ?>" method="post" class="align-content-center">
                    <?php echo csrf_field(); ?>
                                            ...
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr data-id="<?php echo e($enq->id ?? ''); ?>" class="enquiryTr">
                                                    ...
                                                    <td class="pt-0 d-flex">
                                                        ...
                                                        <!-- Edit Button -->
                                                        <a target="_blank" href="<?php echo e(url('esh2/expenses/edit')); ?>/<?php echo e($enq->id); ?>" 
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form action="<?php echo e(url('esh2/expenses/delete/'.$enq->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this expenses?');">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('DELETE'); ?>
                                                            <button type="submit" class="btn btn-icon btn-danger mb-2 btn-outline btn-outline-dashed btn-outline-danger pulse pulse-danger">
                                                                <i class="ki-duotone ki-trash fs-7"><span class="path1"></span><span class="path2"></span></i>
                                                                <span class="pulse-ring"></span>
                                                            </button>
                                                        </form>
                                                    </td>
                                                    <td class="pt-0"><?php echo e($i++); ?></td>
                                                    <td class="pt-0"><small><?php echo e($enq->user_name ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->expense_name ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->date ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->quantity ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->rate ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->total_amt ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->description ?? ''); ?></small></td>
                                                    <td>
                                                        <?php if($enq->status == 1): ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            //         url: hostUrl + '/esh2/expenses/list',
            //         method: 'post',
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            url: "<?php echo e(url('esh2/expenses/statusChange')); ?>",
                            type: "POST",
                            data: formData,
                            success: function(response) {
                                if (response.success) {
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/expenses/list.blade.php ENDPATH**/ ?>