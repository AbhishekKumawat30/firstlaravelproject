            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="card">
                    <div class="card-body py-4">
                        <form id="branch_add_form" class="form" action="<?php echo e(url('esh2/roles/add')); ?>"
                            ...
                            <div class="text-center pt-10">
                                ...
                                <button type="button" id="addroles" class="btn btn-primary"
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/roles/add.blade.php ENDPATH**/ ?>