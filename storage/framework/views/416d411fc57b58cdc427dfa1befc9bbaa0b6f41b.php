...
<div id="kt_app_header" class="app-header " 
	...
	<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
		<a href="index.html" class="d-lg-none">
			<img alt="Logo" src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/logos/default-small.svg'); ?>" class="h-30px"/>
		</a>
	</div>
	<!--end::Mobile logo-->
...
<!--end::Chat drawer--> 
<!--end::Drawers--><?php /**PATH /home/rukmanisoftware/public_html/web/resources/views/common/header.blade.php ENDPATH**/ ?>