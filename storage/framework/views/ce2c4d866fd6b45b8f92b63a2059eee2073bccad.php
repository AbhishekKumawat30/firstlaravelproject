...
<?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>-->
                        ...
                        <a href="<?php echo e(url('esh2/imagegallery/add')); ?>" class="d-flex btn btn-sm fw-bold btn-primary">
                                            ...
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr data-id="<?php echo e($enq->id ?? ''); ?>" class="enquiryTr">
                                                    ...
                                                    <td class="pt-0 d-flex">
                                                        ...
                                                        <!-- Edit Button -->
                                                        <a target="_blank"
                                                            href="<?php echo e(url('esh2/imagegallery/edit')); ?>/<?php echo e($enq->id); ?>"
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form action="<?php echo e(url('esh2/imagegallery/delete/' . $enq->id)); ?>"
                                                            method="POST"
                                                            onsubmit="return confirm('Are you sure you want to delete this Imagegallery?');">
                                                            <?php echo csrf_field(); ?>
                                                    ...
                                                    <td class="pt-0 align-items-center">
                                                        <?php echo e($enq->eventname ?? ''); ?> <br> <small>
                                                    </td>
                                                    <td>
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'esh2/imagegallery/' . $enq->image); ?>"
                                                            alt="Enquiry image"
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/imagegallery/view.blade.php ENDPATH**/ ?>