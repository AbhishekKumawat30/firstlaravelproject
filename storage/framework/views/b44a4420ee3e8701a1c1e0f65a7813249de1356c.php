        ...
        <div class="row">
          <div class="col-12 col-md-12">
            <div class="card card-outline card-orange">
                    ...
                    <h3 class="card-title"><i class="fa fa-calendar-check-o"></i> &nbsp;<?php echo e(__('staff.View Staff Attendance')); ?></h3>
                ...
                <table id="example11" class="table table-bordered table-striped border table-responsive dataTable dtr-inline ">
                    <thead>
                    <tr role="row">
                      <td class="sticky-col first-col"><?php echo e(__('common.SR.NO')); ?></td>
                       <?php
                     $monthDate =$totel_month_day;
                      ?>
                            <td class="sticky-col second-col"><?php echo e(__('common.Name')); ?></td>
                      ...
                      ?>
                        <?php $__currentLoopData = $all_teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         ...
                         <tr>
                             <input type="hidden" class=" " id="teacher_id" name="teacher_id" readonly  value="">
                        ...
                        <?php if(isset($data[$item['id']][$date])): ?>
                            <td class="text-center">
                               ...
                               $todayHistory = DB::table('teacher_attendance')->select('teacher_attendance.*','attendance_status.simbel')
                                                    ->leftjoin('attendance_status','attendance_status.id','teacher_attendance.attendance_status_id')->where('teacher_id', $item['id'])->where('date',$date)->WhereNull('teacher_attendance.deleted_at')->orderBy('attendance_status_id','ASC')->get();
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/staff/staff_attendance/index.blade.php ENDPATH**/ ?>