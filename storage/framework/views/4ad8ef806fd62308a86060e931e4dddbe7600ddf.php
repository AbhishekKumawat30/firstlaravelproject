<?php $__env->startSection('content'); ?>
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <div class="m-0">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-md-1000px" data-kt-menu="true"
                                ...
                                <!--begin::Form-->
                                <div class="px-7 py-5">
                                    <form action="<?php echo e(url('esh2/certificate/list')); ?>" method="post" class="row">
                                        <?php echo csrf_field(); ?>
    ...
    <?php endif; ?>-->
                        ...
                        <a href="<?php echo e(url('esh2/certificate/add')); ?>" class="d-flex btn btn-sm fw-bold btn-primary">
            ...
            <div class="align-items-center gap-2 gap-lg-3 p-3"
                ...
                <form action="<?php echo e(url('esh2/certificate/list')); ?>" method="post" class="align-content-center">
                    <?php echo csrf_field(); ?>
                                            ...
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr data-id="<?php echo e($enq->id ?? ''); ?>" class="enquiryTr">
                                                    ...
                                                    <td class="pt-0 d-flex">
                                                        ...
                                                        <!-- Edit Button -->
                                                        <a target="_blank"
                                                            href="<?php echo e(url('esh2/certificate/edit')); ?>/<?php echo e($enq->id); ?>"
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form action="<?php echo e(url('esh2/certificate/delete/' . $enq->id)); ?>"
                                                            method="POST"
                                                    ...
                                                    <td>
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'esh2/certificate /' . $enq->photo); ?>"
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/certificate/list.blade.php ENDPATH**/ ?>