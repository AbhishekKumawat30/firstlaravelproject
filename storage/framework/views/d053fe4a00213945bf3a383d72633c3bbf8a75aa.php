					...
					<div class="card card-outline card-orange">
                        ...
                        <form id="quickForm_addmission" action="<?php echo e(url('add_weekend')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <!-- <div class="col-md-3">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label><?php echo e(__('Date')); ?><span style="color:red;">*</span></label>
										<input type="date" class="form-control invalid" id="date" name="date" placeholder=" Date" value="<?php echo e(old('date')); ?>" required>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/master/Weekendcalendar/add.blade.php ENDPATH**/ ?>