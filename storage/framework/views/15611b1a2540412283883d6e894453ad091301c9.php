                    ...
                    <div class="row">
                        <div class="col-md-3">
	    	                <div class="form-group">
				                ...
				                <input type="file" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?> class="form-control <?php $__errorArgs = ['photo'];
...
unset($__errorArgs, $__bag); ?>">
                                <input type="file" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?> name="father_img" id="father_img" value="<?php echo e($data['father_img'] ?? ''); ?>">
...
unset($__errorArgs, $__bag); ?>">
                                <input type="file" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?> name="mother_img" id="mother_img" value="<?php echo e($data['mother_img'] ?? ''); ?>">
            ...
            <?php endif; ?>        
		                 <div class="col-md-3">
            				<div class="form-group"> 
            					...
            					<input type="text" class="form-control "  value="<?php echo e($data['userName'] ?? ""); ?>" placeholder="User Name" disabled>
...
unset($__errorArgs, $__bag); ?> " name="first_name" id="first_name" value="<?php echo e($data['first_name'] ?? ""); ?>" placeholder="First name" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?> " name="last_name" id="last_name" value="<?php echo e($data['last_name'] ?? ""); ?>" placeholder="Last name" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="dob" name="dob" value="<?php echo e($data['dob'] ?? ""); ?>" placeholder="Date Of Birth" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?>>
            					<?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?> " name="mobile" id="mobile" value="<?php echo e($data['mobile'] ?? ""); ?>" placeholder="Mobile" maxlength="10" onkeypress="javascript:return isNumber(event)" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?> " name="email" id="email" value="<?php echo e($data['email'] ?? ""); ?>" placeholder="Email" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?> " name="father_name" id="father_name" value="<?php echo e($data['father_name'] ?? ""); ?>" placeholder="Father Name" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?> " name="mother_name" id="father_name" value="<?php echo e($data['mother_name'] ?? ""); ?>" placeholder="Mother Name" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
			            	 ...
			            	 <div class="col-md-3">
                    	    	<div class="form-group">
                    				...
                    				<input type="text" class="form-control" id="father_mobile" name="father_mobile" placeholder=" Father's Contact No." value="<?php echo e($data['father_mobile'] ?? ''); ?>" maxlength="10" onkeypress="javascript:return isNumber(event)" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?>>
                    		    </div>
                    		  </div>
            			 ...
            			 <div class="col-md-3" >
                            <div class="form-group">
                             <label>Country</label>
                              <select class="form-control select2" name="country_id" id="country_id" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?> >
...
unset($__errorArgs, $__bag); ?>
            			...
            			<div class="col-md-3">
            				<div class="form-group"> 
            					...
            					<select class="form-control" id="state_id" name="state_id" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            			...
            			<div class="col-md-3">
            			    <div class="form-group">
            			        ...
            			        <select class="form-control" name="city_id" id="city_id" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?> >
...
unset($__errorArgs, $__bag); ?>" id="address" name="address" value="<?php echo e($data['address'] ?? ""); ?>" placeholder="Address" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="pincode" name="pincode" value="<?php echo e($data['pincode'] ?? ""); ?>" placeholder="Pin Code" <?php echo e(Session::get('role_id') != 1 ? 'disabled' : ''); ?>>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/profile/profile.blade.php ENDPATH**/ ?>