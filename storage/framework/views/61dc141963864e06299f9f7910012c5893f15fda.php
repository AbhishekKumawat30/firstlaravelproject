...
unset($__errorArgs, $__bag); ?>" id="time_period_id" name="time_period_id" required>
                                            <option value=""><?php echo e(__('common.Select')); ?></option>
                    ...
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            ...
                            <div class="card-tools">
                                ...
                                <?php echo csrf_field(); ?>
                                    <select class="selectDesign" id="class_type_id_print" name="class_type_id_print">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/master/TeacherSubject/add.blade.php ENDPATH**/ ?>