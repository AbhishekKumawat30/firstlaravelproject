                  ...
                  <tbody>
                      ...
                      <?php if(!empty($data)): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                      <?php
                       $classIs = DB::table('class_types')->where('id',$item->class_type_id ?? '')->whereNull('deleted_at')->first('name');
                        ?>
                        
                        <?php if(!empty($classIs)): ?>
                        
                                <?php echo e($classIs->name ?? ''); ?>
                            ...
                            <?php if(Session::get('role_id') !=  3 && Session::get('role_id') !=  2 ): ?> 
                                ...
                                <td>
                                        ...
                                        <ul class="dropdown-menu" style="">
                                          <a href="<?php echo e(url('joining_letter_print')); ?>/<?php echo e($item->id); ?>" target="blank"><li class="dropdown-item text-success" title="Joining print"><i class="fa fa-print text-success"></i><?php echo e(__('staff.Joining print')); ?></li></a>
                                          <a href="<?php echo e(url('teachers/edit',$item->id)); ?>"><li class="dropdown-item text-primary" title="Edit"><i class="fa fa-edit text-primary"></i> <?php echo e(__('common.Edit')); ?></li></a>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/staff/add_teachers/index.blade.php ENDPATH**/ ?>