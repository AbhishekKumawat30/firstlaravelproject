    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <!--end::Menu 1-->        </div>
            ...
            <!--begin::Primary button-->
                     <a href="<?php echo e(url('esh2/customers/gettingStarted')); ?>" class="d-flex btn btn-sm fw-bold btn-primary" >
                ...
                <table class="table table-hover table-striped table-bordered align-middle table-row-dashed fs-7 dataTable" style="width: 1199.5px;" id="enquiryTable">
                    <thead>
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="">A.M.C Date</th>
                            <th class="">A.M.C Amount</th>
                            <th class="">Status</th>
                        </tr>
                    </thead>
                    ...
                    <?php if(!empty($data)): ?>
                        ...
                        <tr data-id="<?php echo e($enq->id ?? ''); ?>" class="enquiryTr">
                            ...
                            <td class="pt-0 d-flex">  
                                ...
                                <a target="_blank" href="<?php echo e(url('esh2/customers/edit')); ?>/<?php echo e($enq->id); ?>" class="btn btn btn-icon btn-info me-2 mb-2 btn-outline btn-outline-dashed btn-outline-info pulse pulse-info "><i class="ki-duotone ki-pencil fs-7"><span class="path1"></span><span class="path2"></span></i><span class="pulse-ring"></span></a>
                            </td>
                            <td class="pt-0"><?php echo e($i++); ?></td>
                            <td>
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3"><a class="text-dark" target="blank" href="https://web.rusoft.in/esh2/enquiry/view/<?php echo e($enq->id ?? ''); ?>">
                                <?php if(!empty($enq->image)): ?>
                                    <div class="symbol-label"><img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'esh2/customers/' . $enq->image); ?>" alt="Enquiry Image" class="w-100" /></div>
                                <?php else: ?>
                            ...
                            <td class="pt-0 align-items-center">
                                  ...
                                  <?php echo e($enq->name ?? ''); ?> <br> <small> <span class="text-primary" >  Reg. Date: <?php echo e(date('d-M-Y', strtotime($enq->created_at))); ?> </span> <span class="text-success" >Email: <?php echo e($enq->email ?? ''); ?></span> <br>  <?php echo e($enq->address ?? ''); ?> </small>
                               
                            </td>
                            <td class="pt-0"><small><a href="tel://<?php echo e($enq->mobile ?? ''); ?>"><?php echo e($enq->mobile ?? ''); ?></a> <br> </small>
                            <small><a href="tel://<?php echo e($enq->mobile2 ?? ''); ?>"><?php echo e($enq->mobile2 ?? ''); ?></a></td>
                            <td class="pt-0"><small><?php echo e($enq->project_name ?? ''); ?></small></td>
                            <td class="pt-0"><small><?php echo e($enq->emc_date ?? ''); ?></small></td>
                            <td class="pt-0"><small><?php echo e($enq->amc_amount ?? ''); ?></small></td>
                            <td class="pt-0"><small><?php echo e($enq->remark ?? ''); ?></small></td>
                           </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                    </tbody>                    
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/customers/list.blade.php ENDPATH**/ ?>