...
-->                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo e(url('expensePrint')); ?>/<?php echo e($item['id']); ?>" target="blank" class="ml-1 btn btn-success  btn-xs" title="Print Expense" ><i class="fa fa-print"></i></a> 
                                        <?php endif; ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/expense/view.blade.php ENDPATH**/ ?>