        ...
        <tbody id="fees_list_show">
              <?php if(!empty($fees)): ?>
                ...
                <tr>
                    ...
                    <a href="<?php echo e(url('fees_ledger_print',$item['Admission']['id'] ?? '')); ?>"  class="btn btn-success  btn-xs" title="View Fees Ledger"><i class="fa fa-bar-chart-o"></i></a>
                    </td>
                </tr>
              <?php
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/fees/fees_collect/index.blade.php ENDPATH**/ ?>