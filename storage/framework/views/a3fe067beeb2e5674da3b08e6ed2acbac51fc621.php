        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-6 ">
                ...
                <div class="text-end mt-1">
                    <a href="<?php echo e(url('esh2/students/view')); ?>" class="btn btn-primary d-flex align-items-center" style="font-size: 0.99rem; padding: 5px 10px;">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" id="father_name" name="father_name" class="form-control"
                                                value="<?php echo e($data['father_name'] ?? ''); ?>">
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" id="father_mobile" name="father_mobile"
                                                class="form-control" value="<?php echo e($data['father_mobile'] ?? ''); ?>">
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" id="mother_name" name="mother_name" class="form-control"
                                                value="<?php echo e($data['mother_name'] ?? ''); ?>">
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <div class="col-md-4">
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/students/edit.blade.php ENDPATH**/ ?>