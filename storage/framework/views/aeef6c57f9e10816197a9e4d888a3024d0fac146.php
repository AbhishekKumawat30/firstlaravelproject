            ...
            <div class="row m-2">
                ...
                <div class="col-md-1 ">
                     ...
                     <div class="btn-group">
                        ...
                        <button type="submit" name="pdf"  value="pdf" class="btn btn-success <?php echo e(($getPermission->download == 1) ? '' : 'd-none'); ?>"><?php echo e(__('common.Pdf')); ?></button>
                    </div>
            	</div>
                       ...
                       // dd($data);
                        ...
                        <tr>
                                ...
                                <td style="width: 18%;">
                                    ...
                                    <a href="<?php echo e(url('registrationPrint')); ?>/<?php echo e($item->id); ?>" target="blank" class="btn btn-success  btn-xs" title=" Registration Print"><i class="fa fa-print"></i></a>
                                    <?php endif; ?>
                                    <?php if($getPermission->edit == 1): ?>
                                    <a href="javascript:;"  data-id='<?php echo e($item->id); ?>' data-bs-toggle="modal" data-bs-target="#remark_id"  class="remark btn btn-warning  btn-xs ml-3 m-2 " title="Remark Student Registration"><i class="fa fa-bell"></i></a>                                      
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/students/enquiry/view.blade.php ENDPATH**/ ?>