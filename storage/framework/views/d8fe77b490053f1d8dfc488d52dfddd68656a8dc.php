<?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>-->
                        ...
                        <a href="<?php echo e(url('esh2/students/add')); ?>" class="d-flex btn btn-sm fw-bold btn-primary">
                                            ...
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr data-id="<?php echo e($enq->id ?? ''); ?>" class="enquiryTr">
                                                    ...
                                                    <td class="pt-0 d-flex">
                                                        ...
                                                        <a target="_blank"
                                                            href="<?php echo e(url('esh2/students/edit')); ?>/<?php echo e($enq->id); ?>"
                                                        ...
                                                        <form action="<?php echo e(url('esh2/students/delete/' . $enq->id)); ?>"
                                                            method="POST"
                                                    ...
                                                    <td>
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'esh2/students/' . $enq->photo); ?>"
                                                    ...
                                                    <td class="pt-0">
                                                        <small><a
                                                                href="tel://<?php echo e($enq->mobile ?? ''); ?>"><?php echo e($enq->mobile ?? ''); ?></a></small>
                                                    </td>

                                                    <td class="pt-0"><small><?php echo e($enq->email ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->aadhar ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->father_name ?? ''); ?></small></td>
                                                    <td>
                                                        <?php if($enq->status == 1): ?>
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            url: "<?php echo e(url('esh2/certificate/statusChange')); ?>",
                            type: "POST",
                            data: formData,
                            success: function(response) {
                                if (response.success) {
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/students/view.blade.php ENDPATH**/ ?>