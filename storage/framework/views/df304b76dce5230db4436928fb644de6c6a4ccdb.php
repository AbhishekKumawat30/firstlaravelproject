        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card">
                <div class="card-body py-4">
                    <form id="branch_add_form" class="form" action="<?php echo e(url('esh2/certificate/add')); ?>" enctype="multipart/form-data" method="post">
                        <?php echo csrf_field(); ?>
        ...
        $('#addcertificate').click(function () {
            ...
            if (valid) {
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(url('esh2/homeslider/add')); ?>', // Ensure the URL is correct
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function (response) {
                        if (response.status == 1) {
                            Swal.fire({
                                ...
                                window.location.href = '<?php echo e(url('esh2/homeslider/list')); ?>'; // Redirect after successful submission
                            });
                        } else {
                            Swal.fire({
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/homeslider/add.blade.php ENDPATH**/ ?>