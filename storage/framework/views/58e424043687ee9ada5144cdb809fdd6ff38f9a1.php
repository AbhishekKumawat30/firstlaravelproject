...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <div class="m-0">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-md-1000px" data-kt-menu="true"
                                ...
                                <!--begin::Form-->
                                <div class="px-7 py-5">
                                    <form action="<?php echo e(url('esh2/inventery/list')); ?>" method="post" class="row">
                                        <?php echo csrf_field(); ?>
    ...
    <?php endif; ?>-->
                        ...
                        <a href="<?php echo e(url('esh2/inventery/add')); ?>" class="d-flex btn btn-sm fw-bold btn-primary">
            ...
            <div class="align-items-center gap-2 gap-lg-3 p-3"
                ...
                <form action="<?php echo e(url('esh2/inventery/list')); ?>" method="post" class="align-content-center">
                    <?php echo csrf_field(); ?>
                                            ...
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr data-id="<?php echo e($enq->id ?? ''); ?>" class="enquiryTr">
                                                    ...
                                                    <td class="pt-0 d-flex">
                                                        ...
                                                        <!-- Edit Button -->
                                                        <a target="_blank" href="<?php echo e(url('esh2/inventery/edit')); ?>/<?php echo e($enq->id); ?>" 
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form action="<?php echo e(url('esh2/inventery/delete/'.$enq->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this Offer?');">
                                                            <?php echo csrf_field(); ?>
                                                    ...
                                                    <td class="pt-0"><small><?php echo e($enq->company ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->item_name ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->quantity_stock ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->amount ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->total_amount ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->available_stock ?? ''); ?></small></td>
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/inventery/list.blade.php ENDPATH**/ ?>