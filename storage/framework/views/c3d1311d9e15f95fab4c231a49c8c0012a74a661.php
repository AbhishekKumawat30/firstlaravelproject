    ...
    <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url(<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/misc/auth-bg.png'); ?>)">
        ...
        <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">          
            ...
            <a href="../../../index.html" class="mb-0 mb-lg-12">
                <img alt="Logo" src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/logos/custom-1.png'); ?>" class="h-60px h-lg-75px"/>
            </a>    
            <!--end::Logo-->
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/authentication/layouts/corporate/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Jan 2024 04:47:00 GMT -->
</html><?php /**PATH /home/rukmanisoftware/public_html/webold/resources/views/authentication/layouts/corporate/sign-in.blade.php ENDPATH**/ ?>