    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div class="text-end mt-1">
                <a href="<?php echo e(url('esh2/certificate/list')); ?>" class="btn btn-primary d-flex align-items-center" style="font-size: 0.99rem; padding: 5px 10px;">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card">
                <div class="card-body py-4">
                    <form id="branch_edit_form" class="form" action="<?php echo e(url('esh2/certificate/edit')); ?>" enctype="multipart/form-data" method="post">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Name" value="<?php echo e($data['name'] ?? ''); ?>" required />
                                        ...
                                        <div class=" align-items-center d-flex" style="align-items: start !important;justify-content:space-between;">
                                            ...
                                            <div id="photo-preview" class="mt-3 d-inline" style="max-width: 100px; height: auto;margin-top:0 !important;">
                                                <?php if(isset($data['photo']) && !empty($data['photo'])): ?>
                                                    <img src="<?php echo e(asset('public/images/certificate_photos/'.$data['photo'])); ?>" alt="Uploaded Photo" width="100">
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
    ...
    $(document).ready(function () {
        ...
        $('#editcertificate').click(function () {
            ...
            $.ajax({
                ...
                url: '<?php echo e(url("esh2/certificate/edit")); ?>/' + '<?php echo e($data->id); ?>',
                method: 'post',
                data: formData,
                processData: false,
                contentType: false,
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/certificate/edit.blade.php ENDPATH**/ ?>