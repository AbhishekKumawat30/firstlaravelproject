...
<?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>-->
                        ...
                        <a href="<?php echo e(url('esh2/offers/add')); ?>" class="d-flex btn btn-sm fw-bold btn-primary">
                                            ...
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr data-id="<?php echo e($enq->id ?? ''); ?>" class="enquiryTr">
                                                    ...
                                                    <td class="pt-0 d-flex">
                                                        ...
                                                        <!-- Edit Button -->
                                                        <a target="_blank" href="<?php echo e(url('esh2/offers/edit')); ?>/<?php echo e($enq->id); ?>" 
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form action="<?php echo e(url('esh2/offers/delete/'.$enq->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this Offer?');">
                                                            <?php echo csrf_field(); ?>
                                                    ...
                                                    <td class="pt-0"><small><?php echo e($enq->name ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->from_date ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->to_date ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->promo_code ?? ''); ?></small></td>
                                                    <td>
                                                        <?php if($enq->status == 1): ?>
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            url: "<?php echo e(url('esh2/offers/statusChange')); ?>",
                            type: "POST",
                            data: formData,
                            success: function(response) {
                                if (response.success) {
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/offers/view.blade.php ENDPATH**/ ?>