                              ...
                              <td>
                                    <?php if(!empty($exam_roll_no->exam_roll_no)): ?>
                                        <a href="<?php echo e(url('single_exam_admit_card')); ?>/<?php echo e($search['class_type_id'] ?? ''); ?>/<?php echo e($search['exam_id'] ?? ''); ?>/<?php echo e($item->id ?? ''); ?>" target="_blank">
                                             <button form="Form_<?php echo e($key); ?>" type="submit" class="btn btn-success btn-xs ml-3" title="View/Download">
                                    ...
                                    <div class="row" >
                                        <div class="col-md-12 mt-3 mb-3 text-center">
                                            <button type="button"  data-class="<?php echo e($search['class_type_id'] ?? ''); ?>" data-exam="<?php echo e($search['exam_id'] ?? ''); ?>" 
                                                data-stream="<?php echo e($search['stream_id'] ?? ''); ?>" id="quickForm_find1" class="btn btn-success"><i class="fa fa-print" style="font-size: 22px;"></i> </button>
                                        </div>
                                    </div>
                               <?php endif; ?>
                        </form>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/examination/offline_exam/admit_card/download_admit_card.blade.php ENDPATH**/ ?>