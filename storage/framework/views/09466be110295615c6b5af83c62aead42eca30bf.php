            ...
            <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-6 ">
                ...
                <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <a href="<?php echo e(url('esh2/faqs/add')); ?>" class="d-flex btn btn-sm fw-bold btn-primary">
                                            ...
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr data-id="<?php echo e($enq->id ?? ''); ?>" class="enquiryTr">
                                                    <td class="pt-0 d-flex">
                                                        ...
                                                        <!-- Edit Button -->
                                                        <a target="_blank"
                                                            href="<?php echo e(url('esh2/faqs/edit')); ?>/<?php echo e($enq->id); ?>"
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form action="<?php echo e(url('esh2/faqs/delete/' . $enq->id)); ?>"
                                                            method="POST"
                                                    ...
                                                    <td class="pt-0"><small><?php echo e($enq->question ?? ''); ?></small></td>
                                                    <td class="pt-0"><small><?php echo e($enq->answer ?? ''); ?></small></td>
                                                    <td class="pt-0">
                                                        <small><?php echo e($pageNames[$enq->page_name] ?? ''); ?></small>
                                                    </td>
                                                    <td>
                                                        <?php if($enq->status == 1): ?>
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/faqs/view.blade.php ENDPATH**/ ?>