...
<form id="customers_add_form" class="form" action="<?php echo e(url('esh2/customers/gettingStarted')); ?>" enctype="multipart/form-data" method="post" >
    <?php echo csrf_field(); ?>
                    <!--begin::Scroll-->
                    <div 
                    ...
                    <div class="row">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <input type="text" name="name" id="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Customer name" value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <input type="tel" name="mobile" id="mobile" class="form-control form-control-solid mb-3 mb-lg-0" onkeypress="javascript:return isNumber(event)" placeholder="Mobile" value="" />
                            <!--end::Input-->
                        </div>
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <input type="tel" name="mobile2" id="mobile2" class="form-control form-control-solid mb-3 mb-lg-0" onkeypress="javascript:return isNumber(event)" placeholder="Mobile 2" value="" />
                            <!--end::Input-->
                        </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="project_name" id="project_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Project Name" value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="project_link" id="project_link" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Project Link" value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="domain_name" id="domain_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Domain Name" value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="fv-row mb-7">
                                ...
                                <input type="date" name="registration_date" id="registration_date" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="<?php echo e(date('Y-m-d')); ?>" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="fv-row mb-7">
                                ...
                                <input type="date" name="domain_expire_date" id="domain_expire_date" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="fv-row mb-7">
                                ...
                                <input type="date" name="amc_date" id="amc_date" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="fv-row mb-7">
                                ...
                                <input type="tel" name="amc_amount" id="amc_amount" class="form-control form-control-solid mb-3 mb-lg-0" onkeypress="javascript:return isNumber(event)" placeholder="AMC Amount" value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="fv-row mb-7">
                                ...
                                <input type="tel" name="student_count" id="student_count" class="form-control form-control-solid mb-3 mb-lg-0" onkeypress="javascript:return isNumber(event)" placeholder="Student Count" value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="fv-row mb-7">
                                ...
                                <input type="tel" name="user_count" id="user_count" class="form-control form-control-solid mb-3 mb-lg-0" onkeypress="javascript:return isNumber(event)" placeholder="User Count" value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="fv-row mb-7">
                                ...
                                <input type="tel" name="branch_count" id="branch_count" class="form-control form-control-solid mb-3 mb-lg-0" onkeypress="javascript:return isNumber(event)"  placeholder="Branch Count" value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="userName" id="userName" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="User Name" value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="fv-row mb-7">
                                ...
                                <textarea name="plan_details" id="plan_details" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Plan Details" value="" /></textarea>
                            </div>
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <textarea name="remark" id="remark" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Remark" value="" /></textarea>
                            <!--end::Input-->
                        </div>
                        </div>
...
$(document).ready(function(){
    ...
    $('#addCustomer').click(function(){
        ...
        $.ajax({
    	    ...
    	    url: baseurl + '/esh2/customers/gettingStarted',
    	    method : 'post',
            data: formData,
            processData: false,
            contentType: false, 
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/web.rusoft.in/resources/views/esh2/customers/gettingStarted.blade.php ENDPATH**/ ?>