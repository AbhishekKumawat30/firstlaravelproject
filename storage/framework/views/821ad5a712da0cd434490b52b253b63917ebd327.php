...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-md-2">
                     <div class="form-group">
                        <label style="color:red;"><?php echo e(__('common.Aadhaar No.')); ?>*</label>
...
unset($__errorArgs, $__bag); ?>" id="aadhaar" name="aadhaar" placeholder="<?php echo e(__('common.Aadhaar No.')); ?>" value="<?php echo e(old('aadhaar')); ?>" maxlength="12" onkeypress="javascript:return isNumber(event)">
...
unset($__errorArgs, $__bag); ?>		    
                  ...
                  <div class="col-md-2 col-6">
                     <div class="form-group">
                        <label style="color:red;"><?php echo e(__('staff.Date of Joining')); ?>*</label>
...
unset($__errorArgs, $__bag); ?>" id="joining_date" name="joining_date" value="<?php echo e(date('Y-m-d')); ?>">
...
unset($__errorArgs, $__bag); ?>                
                  ...
                  <div class="col-md-2 col-6">
                     <div class="form-group">
                        ...
                        <select class="form-control select2" id="" name="class_type_id">
                           <option value=""><?php echo e(__('common.Select')); ?></option>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/staff/add_teachers/add.blade.php ENDPATH**/ ?>