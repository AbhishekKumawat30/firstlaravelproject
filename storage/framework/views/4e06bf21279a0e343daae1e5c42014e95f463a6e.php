    ...
    <div class="card-body d-flex flex-column justify-content-end pe-0">
        ...
        <div class="symbol-group symbol-hover flex-nowrap">
                            ...
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon">
                                            <img alt="Pic" src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-11.jpg'); ?>" />
                                    </div>
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Susan Redwood">
                                            <span class="symbol-label bg-primary text-inverse-primary fw-bold">S</span>
                                    </div>
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Melody Macy">
                                            <img alt="Pic" src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-2.jpg'); ?>" />
                                    </div>
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Perry Matthew">
                                            <span class="symbol-label bg-danger text-inverse-danger fw-bold">P</span>
                                    </div>
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Barry Walter">
                                            <img alt="Pic" src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-12.jpg'); ?>" />
                                    </div>
...
<div class="card card-flush h-md-100"> 
    ...
    style="background-position: 100% 50%; background-image:url('<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/stock/900x600/42.png'); ?>')">     
        ...
        <!--begin::Illustration-->
        <img class="mx-auto h-150px h-lg-200px  theme-light-show" src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/illustrations/misc/upgrade.svg'); ?>" alt=""/>   
        <img class="mx-auto h-150px h-lg-200px  theme-dark-show" src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/illustrations/misc/upgrade-dark.svg'); ?>" alt=""/>   
        <!--end::Illustration-->
    </div>
    <!--end::Body-->
</div>    
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                        ...
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-3.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-2.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-9.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-7.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-25.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-24.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-20.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-17.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-11.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-23.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-4.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-1.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-12.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-21.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-30.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-14.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-6.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                                                                    <div class="symbol symbol-50px me-3">                                                   
                                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-10.jpg'); ?>" class="" alt=""/>                                                    
                                                    </div>
                ...
                <div class="d-flex flex-column h-100">
                    ...
                    <div class="d-flex flex-stack mt-auto bd-highlight">  
                        ...
                        <div class="symbol-group symbol-hover flex-nowrap">
                                                            ...
                                                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon">
                                                                            <img alt="Pic" src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/avatars/300-3.jpg'); ?>" />
                                                                    </div>
                                                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Susan Redwood">
                                                                            <span class="symbol-label bg-primary text-inverse-primary fw-bold">S</span>
                                                                    </div>
                ...
                <tbody>
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50px me-3">                                                   
                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-49.jpg'); ?>" class="" alt=""/>                                                    
                                    </div>
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50px me-3">                                                   
                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-40.jpg'); ?>" class="" alt=""/>                                                    
                                    </div>
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50px me-3">                                                   
                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-39.jpg'); ?>" class="" alt=""/>                                                    
                                    </div>
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50px me-3">                                                   
                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-47.jpg'); ?>" class="" alt=""/>                                                    
                                    </div>
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50px me-3">                                                   
                                        <img src="<?php echo e(env('IMAGE_SHOW_PATH') . 'assets/media/stock/600x600/img-48.jpg'); ?>" class="" alt=""/>                                                    
                                    </div>
...
<div data-kt-stepper-element="content">
    <div class="w-100 text-center">
        ...
        <div class="text-center px-4 py-15">       
            <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/illustrations/sketchy-1/9.png" alt="" class="mw-100 mh-300px"/>
        </div>
        <!--end::Illustration-->
    </div>
</div>
    ...
    <div class="mh-375px scroll-y me-n7 pe-7">
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="0">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="0"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="1">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="1"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="2">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="2"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="3">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="3"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="4">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="4"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="5">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="5"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="6">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="6"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="7">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="7"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="8">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="8"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="9">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="9"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="10">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="10"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="11">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="11"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="12">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="12"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="13"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="14">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="14"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="15"/>
                    </label>
                    <!--end::Checkbox-->
            ...
            <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="16">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Checkbox-->
                    <label class="form-check form-check-custom form-check-solid me-5">
                        <input class="form-check-input" type="checkbox" name="users" data-kt-check="true" data-kt-check-target="" value="16"/>
                    </label>
                    <!--end::Checkbox-->
...
<div data-kt-search-element="empty" class="text-center d-none">
    ...
    <div class="text-center px-5">
        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/illustrations/sketchy-1/1.png" alt="" class="w-100 h-200px h-sm-325px"/>        
    </div>
    <!--end::Illustration-->
</div>
<!--end::Empty-->                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="btn btn-light-primary fw-bold w-100 mb-8">
                    <img alt="Logo" src="https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3"/>
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/web.rusoft.in/resources/views/dashboards/index.blade.php ENDPATH**/ ?>