            ...
            <div id="kt_app_content_container" class="app-container  container-xxl ">
                ...
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        ...
                        <form id="customers_edit_form" action="<?php echo e(url('esh2/customers/edit') . $data->id); ?>" method="post"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="name" id="name"
                                                ...
                                                placeholder="Customer name" value="<?php echo e($data['name'] ?? ''); ?>" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="email" name="email" id="email"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="example@domain.com" value="<?php echo e($data['email'] ?? ''); ?>" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="project_name" id="project_name"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="Project Name" value="<?php echo e($data['project_name'] ?? ''); ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="project_link" id="project_link"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="Project Link" value="<?php echo e($data['project_link'] ?? ''); ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="domain_name" id="domain_name"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="Domain Name" value="<?php echo e($data['domain_name'] ?? ''); ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <select id="project_mode" class="form-control form-control-solid mb-3 mb-lg-0"
                                                ...
                                                <option value="1"
                                                    <?php echo e(1 == old('project_mode', $data->project_mode) ? 'selected' : ''); ?>>
                                                    Online</option>
                                                <option value="2"
                                                    <?php echo e(2 == old('project_mode', $data->project_mode) ? 'selected' : ''); ?>>
                                                    Offline</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <select id="project_type" class="form-control form-control-solid mb-3 mb-lg-0"
                                                name="project_type">
                                                <option value=""
                                                    <?php echo e(0 == old('project_type', $data->project_type) ? 'selected' : ''); ?>>
                                                    Select</option>
                                                <option value="1"
                                                    <?php echo e(1 == old('project_type', $data->project_type) ? 'selected' : ''); ?>>
                                                    Website</option>
                                                <option value="2"
                                                    <?php echo e(2 == old('project_type', $data->project_type) ? 'selected' : ''); ?>>
                                                    School</option>
                                                <option value="3"
                                                    <?php echo e(3 == old('project_type', $data->project_type) ? 'selected' : ''); ?>>
                                                    APK</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="date" name="registration_date" id="registration_date"
                                                ...
                                                value="<?php echo e($data['registration_date'] ?? ''); ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="date" name="domain_expire_date" id="domain_expire_date"
                                                class="form-control form-control-solid mb-3 mb-lg-0" placeholder=""
                                                value="<?php echo e($data['domain_expire_date'] ?? ''); ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="date" name="amc_date" id="amc_date"
                                                class="form-control form-control-solid mb-3 mb-lg-0" placeholder=""
                                                value="<?php echo e($data['emc_date'] ?? ''); ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="tel" name="amc_amount" id="amc_amount"
                                                ...
                                                value="<?php echo e($data['amc_amount'] ?? ''); ?>" />
                                        </div>
                                    </div>
                                                ...
                                                <?php if(!empty($getState)): ?>
                                                    <?php $__currentLoopData = $getState; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($state->id ?? ''); ?>"
                                                            <?php echo e($state->id == old('state_id', $data->state_id) ? 'selected' : ''); ?>>
                                            ...
                                            <select id="city_id" class="form-control form-control-solid mb-3 mb-lg-0"
                                                ...
                                                <?php if(!empty($getCity)): ?>
                                                    <?php $__currentLoopData = $getCity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cities): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($cities->id ?? ''); ?>"
                                                            <?php echo e($cities->id == old('city_id', $data->city_id) ? 'selected' : ''); ?>>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="tel" name="student_count" id="student_count"
                                                ...
                                                value="<?php echo e($data['student_count'] ?? ''); ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="tel" name="user_count" id="user_count"
                                                ...
                                                value="<?php echo e($data['user_count'] ?? ''); ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="tel" name="branch_count" id="branch_count"
                                                ...
                                                value="<?php echo e($data['branch_count'] ?? ''); ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="userName" id="userName"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="User Name" value="<?php echo e($data['userName'] ?? ''); ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="password" name="password" id="password"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="Password" value="<?php echo e($data['password'] ?? ''); ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea name="address" id="address" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Address"
                                                value="<?php echo e($data['address'] ?? ''); ?>" /><?php echo e($data['address'] ?? ''); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea name="plan_details" id="plan_details" class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="Plan Details" value="<?php echo e($data['plan_details'] ?? ''); ?>" /><?php echo e($data['plan_details'] ?? ''); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea name="remark" id="remark" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Remark"
                                                value="<?php echo e($data['remark'] ?? ''); ?>" /><?php echo e($data['remark'] ?? ''); ?></textarea>
                                            <!--end::Input-->
                                        </div>
                                    </div>
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/customers/edit.blade.php ENDPATH**/ ?>