...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                	    	<div class="form-group">
                	    	    <label style="color:red;"><?php echo e(__('user.Select Action')); ?>*</label>
                                    <div class="row">
                                        <!--<div class="col-sm-3">
                                            <div class="form-group clearfix">
                                                <div class="icheck-primary d-inline">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/user/users/edit.blade.php ENDPATH**/ ?>