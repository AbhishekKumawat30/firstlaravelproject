            ...
            <div id="kt_app_content_container" class="app-container  container-xxl ">
                ...
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        ...
                        <form id="customers_add_form" class="form" action="<?php echo e(url('esh2/customers/gettingStarted')); ?>"
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="project_link" id="project_link"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="Project Link" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="userName" id="userName"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="User Name" value="" autocomplete="off" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea name="plan_details" id="plan_details" class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="Plan Details" value="" /></textarea>
                                        </div>
                                    </div>
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rusoft_web\resources\views/esh2/customers/gettingStarted.blade.php ENDPATH**/ ?>