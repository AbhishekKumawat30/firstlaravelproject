								...
								<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<?php if($item->role_id != 2): ?>
                                            ...
                                            <button data-toggle="modal" data-target="#statusModal" data-id="<?php echo e($item['id'] ?? ''); ?>" class="w-75 btn btn-success btn-sm userStatus" data-status="0">Active</button>
                                 
                                            <?php else: ?>
                    
                                            <button data-toggle="modal" data-target="#statusModal" data-id="<?php echo e($item['id'] ?? ''); ?>" class="w-75 btn btn-danger btn-sm userStatus" data-status="1">Inactive</button>
                                   
                                            <?php endif; ?> 
                                            <?php else: ?>
                                            <select name="status" data-id="<?php echo e($item['id'] ?? ''); ?>" class="form-control statusDrop w-75 <?php echo e($item->status == 0 ? 'bg-danger' : ''); ?> <?php echo e($item->status == 1 ? 'bg-success' : ''); ?> <?php echo e($item->status == 2 ? 'bg-info' : ''); ?>">
									    ...
									    <a href="javascript:;" data-id='<?php echo e($item->id); ?>' data-bs-toggle="modal" data-bs-target="#Modal_id" class="deleteData btn btn-danger  btn-xs ml-3" title="Delete User"><i class="fa fa-trash-o"></i></a> 
									    <?php else: ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eplanetacademy/public_html/erp/resources/views/user/users/view.blade.php ENDPATH**/ ?>