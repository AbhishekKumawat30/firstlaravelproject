...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_65b72cffdc3ec">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" multiple data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_65b72cffdc3ec" data-allow-clear="true">
                    <option></option>
...
<!--end::Content-->	
      ...
      <!--begin::Vendors Javascript(used for this page only)-->
                    ...
                    <!--begin::Custom Javascript(used for this page only)-->
                            <script src="<?php echo e(asset('public/assets/js/custom/apps/customers/list/export.js')); ?>"></script>
                            <script src="<?php echo e(asset('public/assets/js/custom/apps/customers/list/list.js')); ?>"></script>
...
<?php echo $__env->make('common.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rukmanisoftware/public_html/web/resources/views/apps/customers/list.blade.php ENDPATH**/ ?>