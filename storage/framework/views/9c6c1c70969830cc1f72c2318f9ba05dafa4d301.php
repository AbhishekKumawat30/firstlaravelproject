                        ...
                        <tr data-id="<?php echo e($enq->id ?? ''); ?>" class="enquiryTr">
                            ...
                            <td class="pt-0 d-flex">  
                                <?php if(Session::get("role_id") == 1): ?> 
                                    <button class="btn btn btn-icon btn-danger me-2 mb-2 btn-outline btn-outline-dashed btn-outline-danger deleteEnquiry" data-info='{"id":"<?php echo e($enq->id ?? ''); ?>"}'><i class="ki-duotone ki-trash"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span> <span class="path5"></span></i></button>
                                <?php endif; ?> 
                                <button class="btn btn btn-icon btn-info me-2 mb-2 btn-outline btn-outline-dashed btn-outline-info pulse pulse-info editEnquiry" data-info='{"id":"<?php echo e($enq->id ?? ''); ?>", "name":"<?php echo e($enq->name ?? ''); ?>", "mobile":"<?php echo e($enq->mobile ?? ''); ?>", "mobile2":"<?php echo e($enq->mobile2 ?? ''); ?>", "email":"<?php echo e($enq->email ?? ''); ?>", "address":"<?php echo e($enq->address ?? ''); ?>", "remark":"<?php echo e($enq->remark ?? ''); ?>", "reminderDate":"<?php echo e($enq->reminder_date ?? ''); ?>", "message":"<?php echo e($enq->message ?? ''); ?>", "responce_status_id":"<?php echo e($enq->responce_status_id ?? ''); ?>", "type":"<?php echo e($enq->type ?? ''); ?>", "department_id":"<?php echo e($enq->department_id ?? ''); ?>", "label":"<?php echo e($findLabel ?? ''); ?>"}'><i class="ki-duotone ki-pencil fs-7"><span class="path1"></span><span class="path2"></span></i><span class="pulse-ring"></span></button>
                            </td>
